...
def densenet12():
    return densenet_BC_cifar(100, 12, num_classes=10)


def densenet24():
    densenet_BC_cifar(250, 24, num_classes=10)


def densenet40():
    densenet_BC_cifar(190, 40, num_classes=10)


if __name__ == '__main__':
    net = densenet_BC_cifar(100, 12, num_classes=10)
